                        ...
                        <div class="col-md-3">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <a href="{{ route('admin.stories.crawl.form', $story) }}" class="btn btn-sm btn-info mt-2">
                        ...
                        <div class="col-md-3">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <a href="{{ route('admin.stories.scan.form', $story) }}" class="btn btn-sm btn-primary mt-2">
                        ...
                        <div class="col-md-3">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <a href="{{ route('admin.stories.chapters', $story) }}" class="btn btn-sm btn-success mt-2">
                        ...
                        <div class="col-md-3">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <a href="{{ route('admin.stories.tts.form', $story) }}" class="btn btn-sm btn-warning mt-2">
                        ...
                        <div class="col-md-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <a href="{{ route('admin.stories.video', $story) }}" class="btn btn-sm btn-purple mt-2">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.stories.chapters', $story) }}" class="btn btn-sm btn-primary">
